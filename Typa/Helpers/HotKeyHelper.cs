...
namespace Typa.Helpers
{
    ...
    public class HotKeyHelper : IDisposable
    {
        ...
        public HotKeyHelper(Window handlerWindow, Action<int> hotKeyHandler)
        {
                ...
                _windowHandle = new WindowInteropHelper(handlerWindow).EnsureHandle();
        ...
        /// </summary>
        // --------------------------------------------------------------------------
        public uint ListenForHotKey(System.Windows.Forms.Keys key, HotKeyModifiers modifiers)
        {
